...
If I were asking you to create a new playlist and add a song to the playlist, I would be willing to bet you could do it in the earlier version of iTunes faster than in the later version. Even if you had never used the earlier version. This is attributed to discoverability built into the UI. That is, users can look and easily know how to navigate. As UI/UX design has moved forward, there seems to have been a shift away from discoverability in the classic sense. I would now wager the words means to go out and have to discover and find through exploration. Where as this may lead to a cleaner look and aesthetic, it masks the usefulness of most software from the layperson or common user. If I have trouble finding out how to add something to my Library using Apple Music, there is a really good chance my friends and family won’t figure it out. 

Here is one of my favorite examples of recently of poor discoverability. In the Photos app on iOS, there is a new face detection feature in iOS 10 where the system will scan your photo library, and learn who people are using machine learning to group similar looking faces. But, what happens if a face is grouped in that doesn’t match?
...
￼
Again I ask you, how do you remove a face? Do you give up? Scroll down and I can explain.
￼
To remove a face from the learning algorithm because it was grouped incorrectly you have to tap on the “Share” button. That’s the one with the square and arrow pointing up. Why is this only available from this screen? I don’t know? I also want to know how anyone is suppose to figure that out. I happen to figure this out because I am the type that presses every button until I can’t find something and then Google’s for the answer if I still can’t find it. I guarantee you none of my friends or family will figure this out without asking me. It isn’t intuitive, it is not user friendly, and detracts from the experience.
